...
{    
    ...
    Vector2 ballPosition = {(float)screenWidth / 2, (float)screenHeight / 2}; // 초기 공이 나올 위치
    Vector2 ballPosition2 = {(float)screenWidth / 3, (float)screenHeight / 3};
   ...
   struct mosquitto *mosq; // 받는애
    ...
    int rc_pub;
    mosq_pub = mosquitto_new("publisher-test", true, NULL);
